...
CREATE TABLE `detail` (
  `id` int(11) NOT NULL,
  `tk` varchar(30) COLLATE utf8_vietnamese_ci NOT NULL,
  `mk` varchar(30) COLLATE utf8_vietnamese_ci NOT NULL,
...
INSERT INTO `detail` (`id`, `tk`, `mk`, `money`) VALUES
(3, 'tk1', 'mk1', 19817);
